...
author:
  ...
  - name: Jeremy Berg and John Novembre
    affiliation: University of Chicago
date: "August 14, 2026"
output:
  pdf_document:
...
graphics: yes
endnote: no
thanks: "This document is included as part of the Advanced Computing tutorial packet for the BSD qBio Bootcamp, University of Chicago, 2026. **Current version**: `r format(Sys.time(), '%B %d, %Y')`."
---

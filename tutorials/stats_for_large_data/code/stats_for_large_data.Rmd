...
author:
  name: Stefano Allesina (adapted by Lin Chen and Xuanyao Liu)
...
graphics: yes
endnote: no
thanks: "This document is included as part of the 'Statistics for a data rich  world' tutorial packet for the BSD qBio Bootcamp, University of Chicago, 2026. **Current version**: `r format(Sys.time(), '%B %d, %Y')`."

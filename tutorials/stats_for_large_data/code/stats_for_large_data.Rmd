...
graphics: yes
endnote: no
thanks: "This document is included as part of the 'Statistics for a data rich  world' tutorial packet for the BSD qBio Bootcamp, University of Chicago, 2025. **Current version**: `r format(Sys.time(), '%B %d, %Y')`."

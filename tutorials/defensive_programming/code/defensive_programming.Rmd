...
author:
  - name: Sarah Cobey (adapted by Kyle Hernandez and John Novembre)
...
endnote: no
chapter: 4
thanks: "This document is included as part of the 'Defensive Programming in R' tutorial packet for the BSD qBio Bootcamp, University of Chicago, 2026. **Current version**: `r format(Sys.time(), '%B %d, %Y')`."
...
$$
\includegraphics[width=0.7\textwidth]{images/subtypes.png}
$$
